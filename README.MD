...
Each manifest will need to have Secrets, environmental variables adjusted. Most if not all are configured to be accessible via k8's `Ingress` therefore I advise you to adjust it all to your domain.
